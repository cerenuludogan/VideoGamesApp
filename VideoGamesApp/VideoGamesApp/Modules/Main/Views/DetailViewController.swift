...
class DetailViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        if let game = game {
            ...
            gameratingLabel.attributedText = createRatingText(with: game.rating!)
    ...
    private func configureView() {
        ...
        // Blur effect view oluştur
        let blurEffect = UIBlurEffect(style: .regular) // İstediğiniz blur effect stiline göre değiştirin
